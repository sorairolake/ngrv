...
* Add more archive formats for releases ({pull-request-url}/117[#117])

== {compare-url}/v0.1.2\...v0.1.3[0.1.3] - 2025-07-28

=== Changed

* Stop building a man page when compiling a package ({pull-request-url}/67[#67])
