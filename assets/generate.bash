...
curl -L -O --skip-existing https://www.kernel.org/pub/software/scm/git/git-2.49.0.tar.xz
echo "618190cf590b7e9f6c11f91f23b1d267cd98c3ab33b850416d8758f8b5a85628  git-2.49.0.tar.xz" | sha256sum -c
curl -L -O --skip-existing https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.14.tar.xz
